# Run Record: sub144-L1-L2-TR-parser-retry

- Timestamp: 20260915-003332
- Branch: main
- Commit: 0a5371f
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/sharedreward-aging`
- Raw log: `/ZPOOL/data/projects/sharedreward-aging/logs/runs/20260915-003332_sub144-L1-L2-TR-parser-retry.log`
- Command exit: 1
- Check exit: none
...
COMMAND: bash /ZPOOL/data/projects/sharedreward-aging/code/run_L1stats.sh --manifest /ZPOOL/data/projects/sharedreward-aging/logs/runlists/L1-sub144-recovered.tsv --ppi-seed vs --parallel-types --jobs 2 --log-dir /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872
Paired L1 plan: 2 unit(s), jobs=2, activation + PPI seed-vs
Concurrent analysis types: up to 4 L1 FEAT jobs (2 paired workers).
Per-unit logs: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872
START: ds003745 sub-144 ses-none run-1 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-1.log)
START: ds003745 sub-144 ses-none run-2 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-2.log)
ERROR: failed paired L1 unit: ds003745 sub-144 ses-none run-1 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-1.log)
BEGIN FAILED WORKER LOG TAIL: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-1.log
L1 plan
  dataset: ds003745
  BOLD: /ZPOOL/data/projects/sharedreward-aging/derivatives/harmonized/sub-144/func/sub-144_task-sharedreward_run-01_space-MNI152NLin6Asym_desc-smoothToFWHM6_bold.nii.gz
  confounds: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/confounds_fmriprep/sub-144/func/sub-144_task-sharedreward_run-01_desc-FSLConfounds.tsv
  EV directory: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/EVfiles/ds003745/sub-144/sharedreward/run-1
  source template: /ZPOOL/data/projects/sharedreward-aging/templates/L1_task-sharedreward_model-1_type-act_seed-0_HPC.fsf
  output: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-act_run-1_sm-6.feat
L1 plan
  dataset: ds003745
  BOLD: /ZPOOL/data/projects/sharedreward-aging/derivatives/harmonized/sub-144/func/sub-144_task-sharedreward_run-01_space-MNI152NLin6Asym_desc-smoothToFWHM6_bold.nii.gz
  confounds: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/confounds_fmriprep/sub-144/func/sub-144_task-sharedreward_run-01_desc-FSLConfounds.tsv
  EV directory: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/EVfiles/ds003745/sub-144/sharedreward/run-1
  source template: /ZPOOL/data/projects/sharedreward-aging/templates/L1_task-sharedreward_model-1_type-ppi_seed-VS_HPC.fsf
  output: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-1_sm-6.feat
  seed: /ZPOOL/data/projects/sharedreward-aging/masks/seed-vs.nii.gz
Rendered pooled act FSF: /tmp/sharedreward-pooled.UwSgrK.fsf
Rendered: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_ds003745_sub-144_task-sharedreward_model-fulltrial_type-act_run-1.fsf
To view the FEAT progress and final report, point your web browser at /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-act_run-1_sm-6.feat/report_log.html
Rendered pooled ppi FSF: /tmp/sharedreward-pooled.Nf7t5a.fsf
Rendered: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_ds003745_sub-144_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-1.fsf
To view the FEAT progress and final report, point your web browser at /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-1_sm-6.feat/report_log.html
child process exited abnormally
    while executing
"fsl:exec "${FSLDIR}/bin/feat ${fsfroot}.fsf -D $FD -poststats 0 " -b 119 -h $statsID -N feat4_post -l logs "
    (procedure "firstLevelMaster" line 191)
    invoked from within
...
"if { $done_something == 0 } {
    ...
    if { ! $fmri(inmelodic) } {
       if { $fmri(level) == 1 } {
	      for { set session 1 } { $session <= $fmri(mult..."
    (file "/usr/local/fsl/bin/feat" line 390)
END FAILED WORKER LOG TAIL
ERROR: failed paired L1 unit: ds003745 sub-144 ses-none run-2 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-2.log)
BEGIN FAILED WORKER LOG TAIL: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-043335-274872/ds003745_sub-144_ses-none_task-sharedreward_run-2.log
L1 plan
  dataset: ds003745
  BOLD: /ZPOOL/data/projects/sharedreward-aging/derivatives/harmonized/sub-144/func/sub-144_task-sharedreward_run-02_space-MNI152NLin6Asym_desc-smoothToFWHM6_bold.nii.gz
  confounds: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/confounds_fmriprep/sub-144/func/sub-144_task-sharedreward_run-02_desc-FSLConfounds.tsv
  EV directory: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/EVfiles/ds003745/sub-144/sharedreward/run-2
  source template: /ZPOOL/data/projects/sharedreward-aging/templates/L1_task-sharedreward_model-1_type-act_seed-0_HPC.fsf
  output: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-act_run-2_sm-6.feat
L1 plan
  dataset: ds003745
  BOLD: /ZPOOL/data/projects/sharedreward-aging/derivatives/harmonized/sub-144/func/sub-144_task-sharedreward_run-02_space-MNI152NLin6Asym_desc-smoothToFWHM6_bold.nii.gz
  confounds: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/confounds_fmriprep/sub-144/func/sub-144_task-sharedreward_run-02_desc-FSLConfounds.tsv
  EV directory: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/EVfiles/ds003745/sub-144/sharedreward/run-2
  source template: /ZPOOL/data/projects/sharedreward-aging/templates/L1_task-sharedreward_model-1_type-ppi_seed-VS_HPC.fsf
  output: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-2_sm-6.feat
  seed: /ZPOOL/data/projects/sharedreward-aging/masks/seed-vs.nii.gz
Rendered pooled act FSF: /tmp/sharedreward-pooled.W5nWFl.fsf
Rendered: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_ds003745_sub-144_task-sharedreward_model-fulltrial_type-act_run-2.fsf
To view the FEAT progress and final report, point your web browser at /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-act_run-2_sm-6.feat/report_log.html
Rendered pooled ppi FSF: /tmp/sharedreward-pooled.ILLvra.fsf
Rendered: /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_ds003745_sub-144_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-2.fsf
To view the FEAT progress and final report, point your web browser at /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/ds003745/sub-144/L1_task-sharedreward_model-fulltrial_type-ppi_seed-vs_run-2_sm-6.feat/report_log.html
child process exited abnormally
    while executing
"fsl:exec "${FSLDIR}/bin/feat ${fsfroot}.fsf -D $FD -poststats 0 " -b 119 -h $statsID -N feat4_post -l logs "
    (procedure "firstLevelMaster" line 191)
