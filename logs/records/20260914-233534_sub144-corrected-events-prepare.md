# Run Record: sub144-corrected-events-prepare

- Timestamp: 20260914-233534
- Branch: main
- Commit: 2246451
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/sharedreward-aging`
- Raw log: `/ZPOOL/data/projects/sharedreward-aging/logs/runs/20260914-233534_sub144-corrected-events-prepare.log`
- Command exit: 1
- Check exit: none
...
COMMAND: /ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/bin/python /ZPOOL/data/projects/sharedreward-aging/code/build_analysis_cohort.py
ERROR: task-ready run lacks its FSL nuisance matrix: ('ds003745', '104', '', '1'): /ZPOOL/data/projects/sharedreward-aging/derivatives/fsl/confounds_fmriprep/sub-104/func/sub-104_task-sharedreward_run-01_desc-FSLConfounds.tsv
Traceback (most recent call last):
  File "/ZPOOL/data/projects/sharedreward-aging/code/recover_sub144_analysis.py", line 116, in <module>
    main()
  File "/ZPOOL/data/projects/sharedreward-aging/code/recover_sub144_analysis.py", line 78, in main
...
subprocess.CalledProcessError: Command '['/ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/bin/python', '/ZPOOL/data/projects/sharedreward-aging/code/build_analysis_cohort.py']' returned non-zero exit status 1.
