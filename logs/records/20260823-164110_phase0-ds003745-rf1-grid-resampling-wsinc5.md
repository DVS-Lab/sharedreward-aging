# Run Record: phase0-ds003745-rf1-grid-resampling-wsinc5

- Timestamp: 20260823-164110
- Branch: main
- Commit: cf4570d
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/sharedreward-aging`
- Raw log: `/ZPOOL/data/projects/sharedreward-aging/logs/runs/20260823-164110_phase0-ds003745-rf1-grid-resampling-wsinc5.log`
- Command exit: 0
- Check exit: 0
...
```bash
/ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/bin/python code/run_resampling_batch.py --manifest logs/runlists/ds003745-resampling-ready.tsv --jobs 8 --log-dir logs/ds003745-resampling-wsinc5-current --overwrite 
```

## Check

```bash
/ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/bin/python code/audit_resampling.py --manifest logs/runlists/ds003745-resampling-ready.tsv --reference /ZPOOL/data/projects/rf1-sra-sharedreward/resources/rf1_MNI152NLin6Asym_reference_grid.nii.gz --output logs/records/ds003745-rf1-grid-audit-wsinc5.tsv --fail-on-incomplete 
```

## Log

```text
RUN START: 20260823-164110
PROJECT_ROOT: /ZPOOL/data/projects/sharedreward-aging
GIT: main cf4570d
HOST: CLA19787.tu.temple.edu
USER: tug87422
PWD: /ZPOOL/data/projects/sharedreward-aging
COMMAND: /ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/bin/python code/run_resampling_batch.py --manifest logs/runlists/ds003745-resampling-ready.tsv --jobs 8 --log-dir logs/ds003745-resampling-wsinc5-current --overwrite 

RF1-grid resampling plan: 100 run unit(s), jobs=8, overwrite=true
Reference: /ZPOOL/data/projects/rf1-sra-sharedreward/resources/rf1_MNI152NLin6Asym_reference_grid.nii.gz
Per-unit logs: logs/ds003745-resampling-wsinc5-current
...
Run units checked: 100
Complete run units: 100
Incomplete run units: 0
Audit: /ZPOOL/data/projects/sharedreward-aging/logs/records/ds003745-rf1-grid-audit-wsinc5.tsv
