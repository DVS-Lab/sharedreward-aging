# Run Record: sub144-activation-PPI-parallel-L1-L2

- Timestamp: 20260914-235535
- Branch: main
- Commit: f21a77e
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/sharedreward-aging`
- Raw log: `/ZPOOL/data/projects/sharedreward-aging/logs/runs/20260914-235535_sub144-activation-PPI-parallel-L1-L2.log`
- Command exit: 1
- Check exit: none
- Summary: CHECK PASSED: every ds003745 FSL nuisance matrix is numeric and volume-aligned.
...
COMMAND: bash /ZPOOL/data/projects/sharedreward-aging/code/run_L1stats.sh --manifest /ZPOOL/data/projects/sharedreward-aging/logs/runlists/L1-sub144-recovered.tsv --ppi-seed vs --parallel-types --jobs 2 --log-dir /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615
Paired L1 plan: 2 unit(s), jobs=2, activation + PPI seed-vs
Concurrent analysis types: up to 4 L1 FEAT jobs (2 paired workers).
Per-unit logs: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615
START: ds003745 sub-144 ses-none run-1 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615/ds003745_sub-144_ses-none_task-sharedreward_run-1.log)
START: ds003745 sub-144 ses-none run-2 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615/ds003745_sub-144_ses-none_task-sharedreward_run-2.log)
ERROR: failed paired L1 unit: ds003745 sub-144 ses-none run-1 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615/ds003745_sub-144_ses-none_task-sharedreward_run-1.log)
ERROR: failed paired L1 unit: ds003745 sub-144 ses-none run-2 (log: /ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615/ds003745_sub-144_ses-none_task-sharedreward_run-2.log)
Traceback (most recent call last):
  File "/ZPOOL/data/projects/sharedreward-aging/code/recover_sub144_analysis.py", line 129, in <module>
    main()
  File "/ZPOOL/data/projects/sharedreward-aging/code/recover_sub144_analysis.py", line 115, in main
    run("run_L1stats.sh", "--manifest", l1, "--ppi-seed", "vs", "--parallel-types", "--jobs", "2",
  File "/ZPOOL/data/projects/sharedreward-aging/code/recover_sub144_analysis.py", line 23, in run
    subprocess.run(command, cwd=ROOT, check=True)
  File "/ZPOOL/data/tools/anaconda/tug87422/envs/sharedreward-phase0/lib/python3.11/subprocess.py", line 571, in run
    raise CalledProcessError(retcode, process.args,
subprocess.CalledProcessError: Command '['bash', '/ZPOOL/data/projects/sharedreward-aging/code/run_L1stats.sh', '--manifest', '/ZPOOL/data/projects/sharedreward-aging/logs/runlists/L1-sub144-recovered.tsv', '--ppi-seed', 'vs', '--parallel-types', '--jobs', '2', '--log-dir', '/ZPOOL/data/projects/sharedreward-aging/logs/L1-sub144-20260915-035538-809615']' returned non-zero exit status 1.
